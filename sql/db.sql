...
CREATE TABLE IF NOT EXISTS `ligne_retours` (
  ...
  `montant_restitution` decimal(12,2) DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `retours` (
  ...
  `statut_restitution` enum('en_attente','paye','annule') COLLATE utf8mb4_unicode_ci DEFAULT 'en_attente',
  `montant_total_restitution` decimal(12,2) DEFAULT '0.00',
